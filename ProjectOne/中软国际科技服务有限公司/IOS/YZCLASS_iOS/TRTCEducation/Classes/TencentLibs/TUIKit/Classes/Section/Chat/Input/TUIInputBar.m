...
- (void)defaultLayout
{
    _lineView.frame = CGRectMake(0, 0, self.width, TTextView_Line_Height);
    ...
    _moreButton.frame = CGRectMake(self.width - buttonSize.width - TTextView_Margin, buttonOriginY, buttonSize.width, buttonSize.height);

...
{
    UIAlertController *ac = [UIAlertController alertControllerWithTitle:nil message:@"加群方式" preferredStyle:IS_PAD? UIAlertControllerStyleAlert :UIAlertControllerStyleActionSheet];
...
{
    UIAlertController *ac = [UIAlertController alertControllerWithTitle:nil message:nil preferredStyle:IS_PAD? UIAlertControllerStyleAlert :UIAlertControllerStyleActionSheet];
...
- (void)deleteGroup:(TUIButtonCell *)cell
{
    ...
    UIAlertController *ac = [UIAlertController alertControllerWithTitle:nil message:@"退出后不会再接收到此群聊消息" preferredStyle:IS_PAD? UIAlertControllerStyleAlert :UIAlertControllerStyleActionSheet];

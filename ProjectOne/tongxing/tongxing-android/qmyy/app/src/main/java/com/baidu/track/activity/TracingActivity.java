...
import com.baidu.mapapi.clusterutil.trtc.TRTCMainActivity;
import com.baidu.mapapi.clusterutil.trtc.TRTCNewActivity;
...
//        openGather();
    ...
    private void init() {
        ...
        Button rtc_btn = findViewById(R.id.rtc_btn);
        rtc_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                startActivity(new Intent(TracingActivity.this, TRTCNewActivity.class));
            }
        });

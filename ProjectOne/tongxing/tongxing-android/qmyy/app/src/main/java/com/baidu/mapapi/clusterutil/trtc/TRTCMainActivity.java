package com.baidu.mapapi.clusterutil.trtc;
...
import com.baidu.mapapi.clusterutil.util.GetRequest_Interface;
...
public class TRTCMainActivity extends Activity implements View.OnClickListener, TRTCSettingDialog.ISettingListener, TRTCMoreDialog.IMoreListener, TRTCVideoViewLayout.ITRTCVideoViewLayoutListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //开始进入视频通话房间
        enterRoom();
        Retrofit retrofit = new Retrofit.Builder().baseUrl("http://129.204.129.170:90/")
        ...
        HashMap<String, String> spkfaskhelp = new HashMap<String, String>();
        spkfaskhelp.put("appid", "123");
        spkfaskhelp.put("deviceId", imei);
        spkfaskhelp.put("roomId", roomId + "");
        getRequest_interface.getSPKfAskHelp(spkfaskhelp).enqueue(new Callback<SPKfAskHelp>() {
            @Override
            public void onResponse(Call<SPKfAskHelp> call, Response<SPKfAskHelp> response) {
                SPKfAskHelp body = response.body();
                Log.d(TAG, "onResponse: " + body.getContent());
            }

            @Override
            public void onFailure(Call<SPKfAskHelp> call, Throwable t) {

...
public:
    ...
    *
    */
    virtual void selectScreenCaptureTarget(const LiteAVScreenCaptureSourceInfo &source, const RECT& captureRect, bool captureMouse = true, bool highlightWindow = true) = 0;
